...
async function fillAndDownloadProposal(clientName: string, email: string) {
  ...
  try {
    ...
    form.getTextField('Hardware Term 1').setText(store.dealDetails.term.toString());
    form.getTextField('Hardware Term 2').setText(store.dealDetails.term.toString());
    ...
    form.getTextField('Total Hardware').setText(totalCosts.hardwareTotal.toFixed(2));
    form.getTextField('Total Hardware Term').setText(store.dealDetails.term.toString());
    form.getTextField('Total MRC').setText(totalCosts.totalMRC.toFixed(2));
    form.getTextField('Total MRC Term').setText(store.dealDetails.term.toString());
    form.getTextField('Grand Total').setText(totalCosts.totalIncVat.toFixed(2));
